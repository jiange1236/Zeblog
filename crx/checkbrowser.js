...
function deny() {
	...
	alert("您正在使用 360 软件产品，为保证您的私人信息安全，请立即更换。");
	document.location = "./deny.html";
}

function warn() {
	// 建议：首页中心位置发出红色警告，每页左下角位置都发出黄色警告，推荐浏览器
	if(confirm("您正在使用的浏览器是 Internet Explorer 山寨版，请立即更换。\n是否需要帮助或建议？"))
		document.location = "/warn.html";
}
